                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <div class="breadcome-menu">
                                        <p><b>Availability mon-friday 8am -5pm</b><br /> <button type="button" class="button-default cart-btn">Edit</button></p>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <div class="breadcome-menu">
                                        <p><b>Set new appointment</b><br /> <button type="button" class="button-default cart-btn">Edit</button></p>
                                    </div>
                                </div>
