...
?>
    ...
    <body>
        ...
        <!----------------------------------------- THIS IS THE MODAL FORM FOR THE REJECTION OR CANCELLATION OF REFERRAL ---------------------------------------------->
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                ...
                                <div class="form-group-inner">
                                    <div class="row">
                                        ...
                                        <div class="form-group res-mg-t-15 col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                            <textarea name="description" placeholder="Enter the Reason for Rejecting the Referral Report"></textarea>
                                        </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?php if ($row['ref_status'] == "For Approval" || $row['ref_status'] == "for approval" || $row['ref_status'] == "Pending" || $row['ref_status'] == "pending") {
                                                                ...
                                                                <!-- <a class="btn btn-danger" style="color: white;" href="gc___referral.php?id=<?= $row['ref_id'] ?>"></a> -->
